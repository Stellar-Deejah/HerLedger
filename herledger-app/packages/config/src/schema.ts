...
export const serverEnvSchema = z.object({
  ...
  STELLAR_RPC_URL: z.string().url().optional().describe("Soroban RPC endpoint URL (single, deprecated — prefer STELLAR_RPC_URLS)"),
  STELLAR_RPC_URLS: commaSeparatedUrls.optional().describe("Comma-separated Soroban RPC endpoint URLs (primary first)"),
  ...
  (data) => data.STELLAR_RPC_URLS != null || data.STELLAR_RPC_URL != null,
  {
